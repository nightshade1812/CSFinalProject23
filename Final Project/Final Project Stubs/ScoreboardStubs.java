...
/**
*The ScoreboardStubs class keeps track of the total wins and the win percentage of the overall game. This data can be saved in an external
...
public class ScoreboardStubs extends JPanel
{
   ...
   */
   ...
   /**
   *Creates a ScoreboardStubs instance containing 2 JLabel objects
   */
